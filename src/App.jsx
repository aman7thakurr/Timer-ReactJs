...
function App() { const [initialHour, setInitialHour] = useState(0);
  ...
  return (
    <div className="App">
      <div className="c-timers">
            ...
            <div className="c-timer">
              <div className="timeCount">
                ...
                <div className="toolbox">
                  ...
                  <button type="button" className="c-timer__btn-reset" onClick={resetTimer}>Reset</button>
                </div>
              </div>
              <div className="c-timer__title">
                ...
                <span className="c-timer__edit-wrap">
                 <span className='label'> 
                  ...
                  <input type='number' className='ip'min={0}  value={initialHour}
          onChange={(e) => setInitialHour(parseInt(e.target.value))}></input></span> 
                 <span className='label'>
                  <label className='txt'>Mins</label>
                  <input type='number' className='ip' min={0}  value={initialMinute}
          onChange={(e) => setInitialMinute(parseInt(e.target.value))}></input></span>
                 <span className='label'>
                  <label className='txt'>Sec</label>
                  <input type='number' className='ip' min={0} max={60} value={initialSecond}
          onChange={(e) => setInitialSecond(parseInt(e.target.value))}></input></span>  
        ...
        </div> <div className="progressbar" title="Progress bar">
